...
/***/ (function(module, exports, __webpack_require__) {
	...
	(0, _jquery2.default)('#search').click(function () {
	    (0, _jquery2.default)('.search-button__form').animate({ right: 0 }, 50);
	    ...
	    (0, _jquery2.default)('.search-button__search-bg').click(function () {
	        ...
	        (0, _jquery2.default)('.search-button__form').animate({ right: '-100%' }, 50);
	    });
	});

/***/ })
])
//# sourceMappingURL=0.ab6c113aed3c75ce6367.hot-update.js.map